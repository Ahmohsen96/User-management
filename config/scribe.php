...
return [
     ...
     */
    'title' => env('SCRIBE_TITLE', 'User Management API'),

    /*
     * A short description of the API.
     */
    'description' => env('SCRIBE_DESCRIPTION', 'API documentation for the User Management system.'),

    /*
     * The base URL of the API, used in the generated docs. If left empty, Scribe will guess based on the URL in your config/app.php.
     */
